...
description: Diseñador super-senior del modelo que versiona por cliente los atributos que cambian su tratamiento (condición ante IVA, forma societaria, jurisdicciones de IIBB activas, plan de cuentas propio). Usar al modelar el cliente, su plan de cuentas o cualquier cálculo que dependa de un atributo con vigencia.
---
