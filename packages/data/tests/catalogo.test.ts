...
import {
  ...
  COBERTURAS_DOCUMENTO,
  TIPOS_PERIODO,
  CIERRE_ESTADOS,
  HECHO_VIA,
  PERIODICIDADES_EXPECTATIVA,
  ORIGENES_EXPECTATIVA,
  MOTIVOS_PENDIENTE_CIERRE,
  PENDIENTE_ESTADOS,
...
const DOMINIOS_CERRADOS: DominioCerrado[] = [
  ...
  // -- 0027_cierre_mensual.sql --
  {
    check: 'documento_ingerido_tipo_chk',
    tabla: 'documento_ingerido',
    columna: 'tipo_documento',
    constante: 'TIPOS_DOCUMENTO_CIERRE',
    valores: TIPOS_DOCUMENTO_CIERRE,
    migracion: '0027',
  },
  {
    check: 'documento_ingerido_cobertura_chk',
    tabla: 'documento_ingerido',
    columna: 'cobertura',
    constante: 'COBERTURAS_DOCUMENTO',
    valores: COBERTURAS_DOCUMENTO,
    migracion: '0027',
  },
  {
    check: 'cierre_periodo_tipo_chk',
    tabla: 'cierre_cliente_periodo',
    columna: 'tipo_periodo',
    constante: 'TIPOS_PERIODO',
    valores: TIPOS_PERIODO,
    migracion: '0027',
  },
  {
    check: 'cierre_periodo_estado_chk',
    tabla: 'cierre_cliente_periodo',
    columna: 'cierre_estado',
    constante: 'CIERRE_ESTADOS',
    valores: CIERRE_ESTADOS,
    migracion: '0027',
  },
  {
    check: 'cierre_transicion_estado_desde_chk',
    tabla: 'cierre_transicion',
    columna: 'estado_desde',
    constante: 'CIERRE_ESTADOS',
    valores: CIERRE_ESTADOS,
    migracion: '0027',
  },
  {
    check: 'cierre_transicion_estado_hasta_chk',
    tabla: 'cierre_transicion',
    columna: 'estado_hasta',
    constante: 'CIERRE_ESTADOS',
    valores: CIERRE_ESTADOS,
    migracion: '0027',
  },
  {
    check: 'cierre_transicion_via_chk',
    tabla: 'cierre_transicion',
    columna: 'hecho_via',
    constante: 'HECHO_VIA',
    valores: HECHO_VIA,
  ...
  {
    check: 'expectativa_tipo_chk',
    tabla: 'expectativa_fuente_cliente',
    columna: 'tipo_documento',
    constante: 'TIPOS_DOCUMENTO_CIERRE',
    valores: TIPOS_DOCUMENTO_CIERRE,
    migracion: '0027',
  ...
  {
    check: 'expectativa_periodicidad_chk',
    tabla: 'expectativa_fuente_cliente',
    columna: 'periodicidad',
    constante: 'PERIODICIDADES_EXPECTATIVA',
    valores: PERIODICIDADES_EXPECTATIVA,
    migracion: '0027',
  },
  {
    check: 'expectativa_origen_chk',
    tabla: 'expectativa_fuente_cliente',
    columna: 'origen',
    constante: 'ORIGENES_EXPECTATIVA',
    valores: ORIGENES_EXPECTATIVA,
    migracion: '0027',
  },
  {
    check: 'pendiente_cierre_motivo_chk',
    tabla: 'pendiente_cierre',
    columna: 'motivo_codigo',
    constante: 'MOTIVOS_PENDIENTE_CIERRE',
    valores: MOTIVOS_PENDIENTE_CIERRE,
    migracion: '0027',
  },
  {
    check: 'pendiente_cierre_estado_chk',
    tabla: 'pendiente_cierre',
    columna: 'pendiente_estado',
    constante: 'PENDIENTE_ESTADOS',
    valores: PENDIENTE_ESTADOS,
    migracion: '0027',
  },
  {
    check: 'asiento_propuesto_tipo_chk',
    tabla: 'asiento_propuesto',
    columna: 'tipo',
    constante: 'TIPOS_ASIENTO_PROPUESTO',
    valores: TIPOS_ASIENTO_PROPUESTO,
    migracion: '0027',
  },
  {
    check: 'asiento_propuesto_estado_chk',
    tabla: 'asiento_propuesto',
    columna: 'asiento_estado',
    constante: 'ASIENTO_ESTADOS',
    valores: ASIENTO_ESTADOS,
    migracion: '0027',
  },
  {
    check: 'cuenta_atributo_rol_funcional_chk',
    tabla: 'cuenta_atributo',
    columna: 'rol_funcional',
