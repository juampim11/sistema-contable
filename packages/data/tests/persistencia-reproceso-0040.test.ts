...
async function crearAsiento(
  ...
  // asiento_estado='confirmado' -- este fixture sintético los completa igual que confirmarAsiento()
  // (escrituras.ts), para no confundir la falta de autoría con lo que este test realmente mide.
